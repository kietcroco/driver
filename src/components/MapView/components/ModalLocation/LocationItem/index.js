...
class LocationItem extends React.Component {
    ...
    constructor( props ) {
        ...
        this._waitingCalDistance = false;
    }

    componentWillReceiveProps( nextProps ) {

        // tính lại khoản cách nếu có thay đổi vị trí
        if (
            !nextProps.isTyping && nextProps.currentPosition 
            && 
             (
                !this._waitingCalDistance 
                && ( !this.state.distance || this.props.currentPosition !== nextProps.currentPosition )
             )
        ) {
    ...
    componentDidMount() {
        ...
        // nếu đã dừng gõ và có vị trí hiện tại thì tính khoản cách
